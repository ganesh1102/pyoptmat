...
class BothBasedModel(nn.Module):
	...
	def forward(self, t, y):
		...
		print('Shape of y inside BothBasedModel.forward: ', y.shape)
...
class StrainBasedModel(nn.Module):
	...
	def forward(self, t, y):
		...
		print('Shape of y inside StrainBasedModel.forward: ', y.shape)
		inp = torch.cat((self.erate_fn(t), torch.Tensor(0), y))
		print('Shape of inp inside StrainBasedModel.forward: ', inp.shape)
